...
namespace Taha.WebAPI.Tests.APIControllerTest
{
    ...
    public class CodingTest
    {
        ...
        public void Test_1_Insert()
        {
            ...
            var storeResult = storeController.Insert(stores) as OkNegotiatedContentResult<IEnumerable<Store>>;
            
            var codings = storeResult.Content
                .ToList()
                .Select(t => new Coding()
                {
                    ID = t.ID
            ...
            var response = baseController.Insert(codings) as OkNegotiatedContentResult<IEnumerable<Coding>>;
